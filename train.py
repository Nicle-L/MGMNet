...
def parse_args(argv):
    ...
    parser.add_argument("--save_path", type=str, default="/media/zll/d1/Repo/wxj/image_compression/code/MambaVC/experiments_DOTA", help="save_path")
    parser.add_argument(
